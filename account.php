	...
	<div class="container">
		<div class="account">
			<h2 class="account-in">Account</h2>
				...
				<div>
					<span>Gender*</span>
					<input type="radio" value=male name=g1>Male
					<input type="radio" value=female name=g1>Female
				</div> 	
		...
		if(isset($_POST["b1"]))
		{
			...
			$q="insert into tbl_registration values(NULL, '$f_name', '$m_name', '$l_name', '$g1', '$email', $contact, '$address', $pincode, '$city', '$state', '$country', '$u_name', $password)";
			$p=mysqli_query($con,$q);
			
			if($p>0)
				echo "registration is succeied";
			else
				echo "Error";
		}
		?>
