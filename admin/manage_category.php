...
?>
	<ol class="breadcrumb">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class="">Manage Category</h2>
		...
		<?php
			...
			while($res=mysqli_fetch_array($p))
			{
				echo "<tr>
					<td>$res[1]
					<td><img src='upload/$res[2]' height=150 width=150>
					
					<td><a href='edit_category.php?id=$res[0]'>EDIT |
						<a href='delete_category.php?id=$res[0]'>DELETE
				  </tr>";
			}
