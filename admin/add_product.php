...
?>
	<ol class="breadcrumb">
 	...
 	<div class="grid-form">
 		...
 		<h2 id="forms-example" class="">Add New Product</h2>
		...
		<div class="form-group">
			...
			<input type="text" name="p_code" class="form-control" id="exampleInputEmail1" placeholder="Product Code">
		</div>
		
		
		<div class="form-group">
			<label for="exampleInputEmail1">Product Old Price</label>
			<input type="text" name="p_o_price" class="form-control" id="exampleInputEmail1" placeholder="Product Old Price">
		</div>
		
		
		<div class="form-group">
			<label for="exampleInputEmail1">Product New Price</label>
			<input type="text" name="p_n_price" class="form-control" id="exampleInputEmail1" placeholder="Product New Price">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="p_color" class="form-control" id="exampleInputEmail1" placeholder="Product Color">
		</div>
		
		<div class="form-group">
			<label for="exampleInputEmail1">Product Weight</label>
			<input type="text" name="p_wight" class="form-control" id="exampleInputEmail1" placeholder="Product Wight">
		</div>
	
		<div class="form-group">
			<label for="exampleInputEmail1">Product Dose</label>
			<input type="text" name="p_dose" class="form-control" id="exampleInputEmail1" placeholder="Product dose">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="p_stock" class="form-control" id="exampleInputEmail1" placeholder="Product Stock">
		</div>
...
<center>
	<?php
		...
		if(isset($_POST["b1"]))
		{
			...
			$q="insert into tbl_product values(NULL,$cat_id, $c_id, '$p_name', '$p_code', '$p_o_price', '$p_n_price', '$img1', '$img2', '$p_color', '$p_wight', '$p_dose', '$p_process', '$p_features', '$p_materials', '$p_description', '$p_stock', '$d', $sub_cat_id)";
